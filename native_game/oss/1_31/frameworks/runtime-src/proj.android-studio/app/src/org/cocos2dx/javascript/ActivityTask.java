...
public class ActivityTask extends AsyncTask<String, Void, String> {
    ...
    private String flag;
    public ActivityTask(Context context, String secretId, String businessId, String secretKey ,String flag) {
    ...
    protected String doInBackground(String... strings) {
        ...
        Log.e(TAG,"params data:"+ params.toString());
...
//            Toast.makeText(mContext, "失败", Toast.LENGTH_SHORT).show();
    ...
    private String showResponseResult(InputStream inptStream) {
        ...
        try {
            ...
            JniHelper.YD_CallBack(this.flag,result.toString());
        } catch (IOException e) {
            e.printStackTrace();
        }
