...
var e, t, r, i, n, o, c, s, a, f, u, p, h = h || (e = Math, t = Object.create || function() {
function e() {}
return function(t) {
var r;
...
_process: function(t) {
var r = this._data, i = r.words, n = r.sigBytes, c = this.blockSize, s = n / (4 * c), a = (s = t ? e.ceil(s) : e.max((0 | s) - this._minBufferSize, 0)) * c, f = e.min(4 * a, n);
if (a) {
for (var u = 0; u < a; u += c) this._doProcessBlock(i, u);
var p = i.splice(0, a);
r.sigBytes -= f;
}
return new o.init(p, f);
},
clone: function() {
var e = n.clone.call(this);
...
return r = (t = e).lib, i = r.Base, n = r.WordArray, o = t.algo, c = o.MD5, s = o.EvpKDF = i.extend({
cfg: i.extend({
keySize: 4,
hasher: c,
iterations: 1
...
for (var r = this.cfg, i = r.hasher.create(), o = n.create(), c = o.words, s = r.keySize, a = r.iterations; c.length < s; ) {
f && i.update(f);
var f = i.update(e).finalize(t);
i.reset();
for (var u = 1; u < a; u++) f = i.finalize(f), i.reset();
o.concat(f);
}
...
e.clamp();
for (var n = [], o = 0; o < r; o += 3) for (var c = (t[o >>> 2] >>> 24 - o % 4 * 8 & 255) << 16 | (t[o + 1 >>> 2] >>> 24 - (o + 1) % 4 * 8 & 255) << 8 | t[o + 2 >>> 2] >>> 24 - (o + 2) % 4 * 8 & 255, s = 0; s < 4 && o + .75 * s < r; s++) n.push(i.charAt(c >>> 6 * (3 - s) & 63));
var a = i.charAt(64);
...
for (var n = [], o = 0, c = 0; c < t; c++) if (c % 4) {
var s = i[e.charCodeAt(c - 1)] << c % 4 * 2, a = i[e.charCodeAt(c)] >>> 6 - c % 4 * 2;
...
e.lib.Cipher || (i = (r = e).lib, n = i.Base, o = i.WordArray, c = i.BufferedBlockAlgorithm, 
s = r.enc, a = (s.Utf8, s.Base64), f = r.algo.EvpKDF, u = i.Cipher = c.extend({
cfg: n.extend(),
...
}), p = (i.StreamCipher = u.extend({
_doFinalize: function() {
return this._process(!0);
},
blockSize: 1
}), r.mode = {}), h = i.BlockCipherMode = n.extend({
createEncryptor: function(e, t) {
...
pad: function(e, t) {
for (var r = 4 * t, i = r - e.sigBytes % r, n = i << 24 | i << 16 | i << 8 | i, c = [], s = 0; s < i; s += 4) c.push(n);
var a = o.create(c, i);
e.concat(a);
},
unpad: function(e) {
...
i = this.cfg.extend(i);
var n = e.createEncryptor(r, i), o = n.finalize(t), c = n.cfg;
return y.create({
ciphertext: o,
key: r,
iv: c.iv,
...
var n = f.create({
keySize: t + r
}).compute(e, i), c = o.create(n.words.slice(t), 4 * r);
...
var t, r, i, n, o, c, s, a, f, u, p, h, d, l, y, m, v, _, g;
});

!function(e, t) {
"object" == typeof exports ? module.exports = exports = t(require("./core.min")) : "function" == typeof define && define.amd ? define([ "./core.min" ], t) : t(e.CryptoJS);
}(this, function(e) {
r = (t = e).lib.Base, i = t.enc.Utf8, t.algo.HMAC = r.extend({
init: function(e, t) {
...
return function() {
var t = e, r = t.lib.BlockCipher, i = t.algo, n = [], o = [], c = [], s = [], a = [], f = [], u = [], p = [], h = [], d = [];
!function() {
...
var y = e[r], m = e[y], v = e[m], _ = 257 * e[l] ^ 16843008 * l;
c[r] = _ << 24 | _ >>> 8, s[r] = _ << 16 | _ >>> 16, a[r] = _ << 8 | _ >>> 24, f[r] = _;
_ = 16843009 * v ^ 65537 * m ^ 257 * y ^ 16843008 * r;
u[l] = _ << 24 | _ >>> 8, p[l] = _ << 16 | _ >>> 16, h[l] = _ << 8 | _ >>> 24, d[l] = _, 
r ? (r = y ^ e[e[e[v ^ y]]], i ^= e[e[i]]) : r = i = 1;
}
}();
var l = [ 0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54 ], y = i.AES = r.extend({
_doReset: function() {
if (!this._nRounds || this._keyPriorReset !== this._key) {
for (var e = this._keyPriorReset = this._key, t = e.words, r = e.sigBytes / 4, i = 4 * ((this._nRounds = r + 6) + 1), o = this._keySchedule = [], c = 0; c < i; c++) if (c < r) o[c] = t[c]; else {
var s = o[c - 1];
c % r ? r > 6 && c % r == 4 && (s = n[s >>> 24] << 24 | n[s >>> 16 & 255] << 16 | n[s >>> 8 & 255] << 8 | n[255 & s]) : (s = n[(s = s << 8 | s >>> 24) >>> 24] << 24 | n[s >>> 16 & 255] << 16 | n[s >>> 8 & 255] << 8 | n[255 & s], 
s ^= l[c / r | 0] << 24), o[c] = o[c - r] ^ s;
}
for (var a = this._invKeySchedule = [], f = 0; f < i; f++) {
c = i - f;
if (f % 4) s = o[c]; else s = o[c - 4];
a[f] = f < 4 || c <= 4 ? s : u[n[s >>> 24]] ^ p[n[s >>> 16 & 255]] ^ h[n[s >>> 8 & 255]] ^ d[n[255 & s]];
}
}
},
encryptBlock: function(e, t) {
this._doCryptBlock(e, t, this._keySchedule, c, s, a, f, n);
},
decryptBlock: function(e, t) {
var r = e[t + 1];
e[t + 1] = e[t + 3], e[t + 3] = r, this._doCryptBlock(e, t, this._invKeySchedule, u, p, h, d, o);
r = e[t + 1];
e[t + 1] = e[t + 3], e[t + 3] = r;
},
_doCryptBlock: function(e, t, r, i, n, o, c, s) {
for (var a = this._nRounds, f = e[t] ^ r[0], u = e[t + 1] ^ r[1], p = e[t + 2] ^ r[2], h = e[t + 3] ^ r[3], d = 4, l = 1; l < a; l++) {
var y = i[f >>> 24] ^ n[u >>> 16 & 255] ^ o[p >>> 8 & 255] ^ c[255 & h] ^ r[d++], m = i[u >>> 24] ^ n[p >>> 16 & 255] ^ o[h >>> 8 & 255] ^ c[255 & f] ^ r[d++], v = i[p >>> 24] ^ n[h >>> 16 & 255] ^ o[f >>> 8 & 255] ^ c[255 & u] ^ r[d++], _ = i[h >>> 24] ^ n[f >>> 16 & 255] ^ o[u >>> 8 & 255] ^ c[255 & p] ^ r[d++];
f = y, u = m, p = v, h = _;
}
y = (s[f >>> 24] << 24 | s[u >>> 16 & 255] << 16 | s[p >>> 8 & 255] << 8 | s[255 & h]) ^ r[d++], 
m = (s[u >>> 24] << 24 | s[p >>> 16 & 255] << 16 | s[h >>> 8 & 255] << 8 | s[255 & f]) ^ r[d++], 
v = (s[p >>> 24] << 24 | s[h >>> 16 & 255] << 16 | s[f >>> 8 & 255] << 8 | s[255 & u]) ^ r[d++], 
_ = (s[h >>> 24] << 24 | s[f >>> 16 & 255] << 16 | s[u >>> 8 & 255] << 8 | s[255 & p]) ^ r[d++];
