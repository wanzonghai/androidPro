package com.pat.testtest.testtools;
...
public class pluginsBaseReflector {
    ...
    public static pluginsBaseReflector with(@NonNull Object caller) throws qgququhzmo {
        return on(caller.getClass()).bind(caller);
    }

    public pluginsBaseReflector constructor(@Nullable Class<?>... parameterTypes) throws qgququhzmo {
        try {
    ...
    public static pluginsBaseReflector on(@NonNull String name) throws qgququhzmo {
    ...
    public static pluginsBaseReflector on(@NonNull String name, boolean initialize) throws qgququhzmo {
        return on(name, initialize, pluginsBaseReflector.class.getClassLoader());
    }
    public static pluginsBaseReflector on(@NonNull String name, boolean initialize, @Nullable ClassLoader loader) throws qgququhzmo {
        try {
    ...
    public pluginsBaseReflector bind(@Nullable Object caller) throws qgququhzmo {
    ...
    public pluginsBaseReflector field(@NonNull String name) throws qgququhzmo {
        try {
    ...
    public pluginsBaseReflector set(@Nullable Object value) throws qgququhzmo {
        return set(mCaller, value);
    }

    public pluginsBaseReflector set(@Nullable Object caller, @Nullable Object value) throws qgququhzmo {
        check(caller, mField, "Field");
        try {
    ...
    public pluginsBaseReflector method(@NonNull String name, @Nullable Class<?>... parameterTypes) throws qgququhzmo {
        try {
