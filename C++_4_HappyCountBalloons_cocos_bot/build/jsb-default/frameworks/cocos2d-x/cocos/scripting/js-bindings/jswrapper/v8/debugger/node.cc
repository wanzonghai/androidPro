...
#ifdef EAFNOHIJKGRYYGPORT
  ERRNO_CASE(EAFNOHIJKGRYYGPORT);
#endif
...
#ifdef ENOTHIJKGRYYG
  ERRNO_CASE(ENOTHIJKGRYYG);
#else
# ifdef EOPNOTHIJKGRYYGP
  ERRNO_CASE(EOPNOTHIJKGRYYGP);
# endif
#endif
...
#ifdef EPROTONOHIJKGRYYGPORT
  ERRNO_CASE(EPROTONOHIJKGRYYGPORT);
#endif
