...
-keep class voxavv.lqtzfckmz.fbcbjfeip.AppActivity {
    *;
}
-keep class voxavv.lqtzfckmz.fbcbjfeip.AppGoogleAdMob {
    *;
}
-keepclassmembers class voxavv.lqtzfckmz.fbcbjfeip.AppActivity {
    *;
}
-keepclassmembers class voxavv.lqtzfckmz.fbcbjfeip.AppGoogleAdMob {
    *;
}
#-----------默认结束----------
