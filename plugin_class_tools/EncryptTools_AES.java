...
public class EncryptTools_AES
{
    ...
    public static void encryAesByFile(String file, String encryptPwd){
        try {
            ...
            OutputStream out = new FileOutputStream("E:\\TemplatePro\\plugin_class_tools\\testfile\\"+fileName);
            ...
            while ((r = cis.read(buffer)) > 0) {
				...
				if(writeCount >= fileLen){
					...
					fileWriteContent += "\"" + fileName + "\"" + ",";
					out = new FileOutputStream("E:\\TemplatePro\\plugin_class_tools\\testfile\\"+fileName);
				}
            }
            fileWriteContent += "};";
