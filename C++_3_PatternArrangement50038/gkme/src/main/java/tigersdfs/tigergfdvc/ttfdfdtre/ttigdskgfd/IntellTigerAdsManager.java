 ...
 */
public class IntellTigerAdsManager {
  private static IntellTigerAdsManager instance;
  private final ConsentInformation consentInformation;

  /** Private constructor */
  private IntellTigerAdsManager(Context context) {
    this.consentInformation = UserMessagingPlatform.getConsentInformation(context);
  }

  /** Public constructor */
  public static IntellTigerAdsManager getInstance(Context context) {
    if (instance == null) {
      instance = new IntellTigerAdsManager(context);
    }
