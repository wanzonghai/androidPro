package vfdgrgewaaa.vfdgrgewbbbb.vfdgrgewccc.vvvwwweee;
...
import vfdgrgewaaa.vfdgrgewbbbb.vfdgrgewccc.vvvnnn.Utils;
...
public class SingleTouchView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBeginPos != null) { // 存在起点，则绘制起点的实心圆及其文字
            ...
            canvas.drawText("Starting point", mBeginPos.x-dip_17, mBeginPos.y+dip_17, mBeginPaint);
        }
        if (mEndPos != null) { // 存在终点，则绘制终点的实心圆及其文字
            canvas.drawCircle(mEndPos.x, mEndPos.y, 10, mEndPaint);
            canvas.drawText("End", mEndPos.x-dip_17, mEndPos.y+dip_17, mEndPaint);
        }
    }
