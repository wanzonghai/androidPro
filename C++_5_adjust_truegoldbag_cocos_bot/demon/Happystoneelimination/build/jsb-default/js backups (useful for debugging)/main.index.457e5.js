...
t.getTimeData = function() {
cc.sys.isNative && cc.sys.os == cc.sys.OS_ANDROID && jsb.reflection.callStaticMethod("ldfiig/JsbUtil", "initsdwfgdf", "()V");
};
return t;
}();
o.default = n;
...
var c = t("./DataManager"), a = t("./util/util"), s = cc._decorator, l = s.ccclass, u = s.property, p = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.audioResList = [];
...
r([ u(cc.Node) ], e.prototype, "checkBtn", void 0);
r([ u(cc.Node) ], e.prototype, "page", void 0);
r([ u(cc.Node) ], e.prototype, "lodingPage", void 0);
return r([ l ], e);
}(cc.Component);
o.default = p;
cc._RF.pop();
