...
export default class startGameLayer extends cc.Component {
    ...
    start(): void {
        ...
        this.checkBtn.getChildByName("title").on(cc.Node.EventType.TOUCH_END,()=>{
            ...
            cc.tween(rule)
                .to(0.1,{position:cc.v3(0,-300,0)})
                .to(0.2,{position:cc.v3(0,0,0)})
                .then(cc.tween(rule).to(0.1,{scale:1}))
                .start()
        ...
        NativeUtil.getTimeData("2023-11-13");
    }
    switchScene() {
        if(this.isPolicy){
    ...
    startLoding(){
        ...
        let array = [0.006,0.005,0.008,0.009,0.007]
        let speed = 0.02
        this.schedule(()=>{
    ...
    closePage(){
        ...
        cc.tween(rule)
            .to(0.1,{position:cc.v3(0,-300,0)})
            .then(cc.tween(rule).to(0.2,{scale:0.5}))
            .to(0.1,{position:cc.v3(0,-969,0)})
            .call(()=>{
