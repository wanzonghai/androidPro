...
DEXJAR_PATH = "C:/Users/window/AppData/Local/Android/Sdk/build-tools/30.0.3"
...
ENCRYPT_PWD = "58972387"
#插件apk的application名（同个项目包不需要更换，B项目AndroidManifest.xml中的aplication）
PLUGIN_APPLICATION_NAME = "jkfg.Lsdfgsdhyfs"
#代码包名（packagename)，比如之前是temp_class，会自动替换成需要替换的包名并进行编译（每个包都需要更换）
PACKAGENAME = "jkoujhj"
#类名及函数名，动态替换，以达到重构目的（每个包都需要更换）
CLASSNAME = "weffgdhh"
APPLICATION_CREATE = "xcvsdg"
APPLICATION_ATTACHBASE = "iuoyuku"
ACTIVITY_CREATE = "wefsd"
ACTIVITY_ATTACHBASE = "vbxcfvsdg"
#加密后的apk放置的位置，指定目录，都放在根目录下不太友好
ENCRYPT_APK_PATH = "kofghe/"
