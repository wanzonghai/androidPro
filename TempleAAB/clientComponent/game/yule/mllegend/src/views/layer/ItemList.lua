...
function ItemList:onStart(callback)
    ...
    for i = 1, 3 do
        ...
        local move = cc.EaseSineIn:create(cc.MoveBy:create(i * 0.18, cc.p(0,-ItemList.HEIGHT)))
...
function ItemList:onEnd(dt)
    ...
    for i = 1, 3 do
        ...
        self:Change(true) 
        local move = cc.EaseSineOut:create(cc.MoveTo:create(i * 0.15, cc.p(0,ItemList.HEIGHT / 3 *(i - 1))))
