...
function RewardTipNode:ctor(_data)
    ...
    win_num:setFntFile("GUI/bigwin/bigwin.fnt")
    win_num:hide()
...
function RewardTipNode:createAnimate(_rateNum)
    --粒子
    local particleFile = "GUI/bigwin/za_lb_jbfzmpdl"
	local particleAniName = "a1"--string.format("%s_start", aniNamePrefix)

    local sound = "sounds/YOU_WIN.mp3"
    
    local aniNamePrefix = "a1"
    local spineFile = "GUI/bigwin/sb_lbjs_YOU_WIN/sb_lbjs_MEGAWIN"
    if _rateNum >= self.lGetScoreStep[4] then
        spineFile = "GUI/bigwin/sb_lbjs_SUPER_WIN/sb_lbjs_MEGAWIN"
    	aniNamePrefix = "a1"
        particleAniName = "a3"
        sound = "sounds/SUPER_WIN.mp3"
    elseif _rateNum >= self.lGetScoreStep[3] then
        spineFile = "GUI/bigwin/sb_lbjs_MEGAWIN/sb_lbjs_MEGAWIN"
    	aniNamePrefix = "a1"
        particleAniName = "a2"
        sound = "sounds/MEGA_WIN.mp3"
    elseif _rateNum >= self.lGetScoreStep[2] then
        spineFile = "GUI/bigwin/sb_lbjs_BIGWIN/sb_lbjs_BIGWIN"
    	aniNamePrefix = "a1"
        particleAniName = "a1"
        sound = "sounds/BIG_WIN.mp3"
    end
