...
luaPath.TurnTableHistory = perPath.."TurnTable.TurnTableHistory.lua"
luaPath.VipHelpMoney = perPath.."VipHelpMoney.lua"
luaPath.VipHelperMoneyConfig = perPath.."VipHelperMoneyConfig.lua"
...
luaPath.JumpVipDialog = perPath.."Dialog/JumpVipDialog.lua"        --vip跳转提示框
