...
NetCmdDefine.S_SUB_LOAD_SIGN_CONFIG					= 2140			--查询签到配置
NetCmdDefine.C_SUB_LOAD_SIGN_CONFIG					= 2141			--查询签到配置返回
NetCmdDefine.S_SUB_LOAD_SIGN_STATUS					= 2142			--查询签到状态
NetCmdDefine.C_SUB_LOAD_SIGN_STATUS				    = 2143			--查询签到状态返回
NetCmdDefine.S_SUB_LOAD_SIGN_OPTAION				= 2144			--执行签到
NetCmdDefine.C_SUB_LOAD_SIGN_OPTAION				= 2145			--执行签到返回
NetCmdDefine.S_SUB_LOAD_SIGN_CONTINUE				= 2146			-- 领取连续签到的奖励
NetCmdDefine.C_SUB_LOAD_SIGN_CONTINUE				= 2147			-- 领取连续签到的奖励返回
...
NetCmdDefine.SUB_MB_GetGrowLevelConfig              = 1508          --获取成长等级配置 1508
NetCmdDefine.SUB_MB_GetGrowLevelConfigResult        = 1509          --获取成长等级配置 返回 1509

NetCmdDefine.SUB_MB_BaseEnsureLoadConfig             = 2100          -- 破产补助 - 加载配置
NetCmdDefine.SUB_MB_BaseEnsureLoadConfigResult             = 2101          -- 破产补助 - 加载配置 返回
NetCmdDefine.SUB_MB_BaseEnsureGetStatus              = 2102          -- 破产补助 - 获取用户状态2102
NetCmdDefine.SUB_MB_BaseEnsureGetStatusResult              = 2103          -- 破产补助 - 获取用户状态2102 返回
NetCmdDefine.SUB_MB_BaseEnsureTakeReward             = 2104          -- 破产补助 - 领取奖励
NetCmdDefine.SUB_MB_BaseEnsureTakeRewardResult             = 2105          -- 破产补助 - 领取奖励 返回

NetCmdDefine.SUB_MB_PopWinPolicyLoadConfig              = 2120          -- 客户端弹窗策略平台配置2120
NetCmdDefine.SUB_MB_PopWinPolicyLoadConfigResult              = 2121          -- 客户端弹窗策略平台配置2121 返回
NetCmdDefine.SUB_MB_PopWinPolicyGetUserStatus             = 2122          -- 客户端弹窗策略用户配置
NetCmdDefine.SUB_MB_PopWinPolicyGetUserStatusResult             = 2123          -- 客户端弹窗策略用户配置 返回
...
NetCmdDefine.CMD_MB_PlacePayOrder  = 2000                   -- 新增充值订单  请求 2000
NetCmdDefine.CMD_MB_PlacePayOrderResult  = 2001             -- 新增充值订单  返回 2001
NetCmdDefine.CMD_MB_PlaceWithdrawOrder  = 2002              -- 新增提现订单  请求 2002
NetCmdDefine.CMD_MB_PlaceWithdrawOrderResult  = 2003        -- 新增提现订单  返回 2003
...
NetCmdDefine.SUB_MB_GetPayChannel                       = 2160          --获取可用的充值或者提现渠道
NetCmdDefine.SUB_MB_GetPayChannelResult                 = 2161          --获取可用的充值或者提现渠道返回
NetCmdDefine.CMD_MB_AlmzLoadConfig                      = 2180          --获得救济金vip的配置
NetCmdDefine.CMD_MB_AlmzLoadConfigResult                = 2181          --获得救济金vip的配置返回
NetCmdDefine.CMD_MB_AlmzGetUserStatus                   = 2182          --获取VIP的救援金用户状态
NetCmdDefine.CMD_MB_AlmzGetUserStatusResult             = 2183          --获取VIP的救援金用户状态返回
NetCmdDefine.CMD_MB_AlmzTakeReward                      = 2184          --领取vip救援金
NetCmdDefine.CMD_MB_AlmzTakeRewardResult                = 2185          --领取vip救援金返回
