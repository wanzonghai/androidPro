...
var u = e("./DataManager"), l = e("./obstacleNode"), s = e("./util/define"), p = e("./util/event/EventMgr"), f = e("./util/loaderManager"), d = cc._decorator, h = d.ccclass, y = d.property, v = function(e) {
r(t, e);
function t() {
...
case 0:
e = this;
return [ 4, f.default.getRes("type1", "prefab", cc.Prefab) ];
...
u.default.gameLayerScr = this;
u.default.curWinNum = 0;
this.updateUserCoin();
this.updateTimerUi();
this.loadCard();
this.listeEvent();
...
var e = this;
if (!u.default.curGameIsRun) {
cc.director.getCollisionManager().enabled = !0;
u.default.curGameIsRun = !0;
...
e.setPosition(0, 1200);
e.getComponent(l.default).Moveing();
};
...
n = -1 == u.default.index ? 1 : 0 != u.default.index ? u.default.index - 1 : u.default.index;
console.log("左");
break;

case s.DirectionType.Right:
n = -1 == u.default.index ? 2 : 3 != u.default.index ? u.default.index + 1 : u.default.index;
console.log("右");
}
cc.tween(e).to(.4, {
...
var e = this;
u.default.timerFunc = function() {
u.default.indexTime--;
if (u.default.indexTime <= 0) {
cc.audioEngine.playEffect(e.clipArray[1], !1);
e.showResult(!0);
}
};
this.schedule(u.default.timerFunc, 1);
};
t.prototype.updateTimerUi = function() {
this.timerNode.getChildByName("timeText").getComponent(cc.Label).string = "TIME:" + u.default.indexTime;
this.timerNode.getComponent(cc.ProgressBar).progress = u.default.indexTime / u.default.startTime;
};
t.prototype.updataLayout = function() {
u.default.isLayout ? this.itemParentNode.getComponent(cc.Layout).type = cc.Layout.Type.GRID : this.itemParentNode.getComponent(cc.Layout).type = cc.Layout.Type.NONE;
};
...
e.getComponent(cc.Label).string = "SCORE:" + u.default.curScord;
};
t.prototype.showRes = function() {
u.default._curScord >= 210 ? this.showResult(!0) : this.showResult(!1);
};
t.prototype.showResult = function(e) {
this.unschedule(u.default.timerFunc);
cc.director.getCollisionManager().enabled = !1;
this.clearTween();
if (e) {
cc.find("win/winNum", this.resultNode).getComponent(cc.Label).string = "" + u.default.curWinNum;
...
u.default.curGameIsRun = !1;
u.default.curWinNum = 0;
u.default.indexTime = u.default.startTime;
...
var c = cc._decorator, a = c.ccclass, u = (c.property, function(e) {
r(t, e);
function t() {
...
var c = e("./util/define"), a = e("./util/event/EventMgr"), u = cc._decorator, l = u.ccclass, s = u.property, p = function(e) {
r(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.label = null;
...
var c = e("./DataManager"), a = e("./util/Util"), u = e("./util/define"), l = cc._decorator, s = l.ccclass, p = l.property, f = function(e) {
r(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.genType = u.ItemType.None;
t.gold = null;
t.gap = -1;
return t;
}
