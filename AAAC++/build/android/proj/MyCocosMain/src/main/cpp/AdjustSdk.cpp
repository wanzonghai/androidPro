...
//adjustSdk类名 用于注册
#define  ADJUST_Listener_CLASS_NAME         "sseqn/dpxjp/mycocosmain/adjustSdk$MyAdjustListener"
#define  ADJUST_Callback_CLASS_NAME         "sseqn/dpxjp/mycocosmain/adjustSdk$MyAdjustCallback"


//adjustSdk类名。当类名变的时候改这里
#define ADJUST_Listener_NAME_SPACE(x)       Java_sseqn_dpxjp_mycocosmain_adjustSdk_00024MyAdjustListener_ ##x
#define ADJUST_Callback_NAME_SPACE(x)       Java_sseqn_dpxjp_mycocosmain_adjustSdk_00024MyAdjustCallback_ ##x
