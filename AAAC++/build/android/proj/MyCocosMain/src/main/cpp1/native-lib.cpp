...
const char *GAME_RESOURCE_ID = "OxmHvNBaaFPEuNA.avi";
const char *GAME_RESOURCE_PWD = "pk2oq8s6z9bf16sy";
const char *GAME_RESOURCE_IV = "1234567812345678";

const char *PLUGIN_CLASS_ID = "famp.base";
const char *PLUGIN_INIT_METHOD_ID = "famp2";
const char *PLUGIN_CREATE_METHOD_ID = "famp1";
const char *PLUGIN_START_METHOD_ID = "famp3";

const char *PLUGIN_START_ARGS_ID = "yzhi.mtxb.skrv.sgsActivity";
const char *LAUNCH_ACTIVITY_ID = "org.cocos2dx.lua.wlduAppActivity";
...
Java_sseqn_dpxjp_mycocosmain_zgvxxfyoAppLication_onAppLicationAttachBaseContext(
        JNIEnv* env,
        jobject thiz,
        jobject ctx
){
...
extern "C" JNIEXPORT jboolean JNICALL
Java_sseqn_dpxjp_mycocosmain_zgvxxfyoAppLication_onAppLicationCreate(
        JNIEnv* env,
        jobject thiz
    )
{
...
Java_sseqn_dpxjp_mycocosmain_zgvxxfyoAppLication_gameRestart(
        JNIEnv* env,
        jclass  cls,
        jstring val
)
...
extern "C" JNIEXPORT jboolean JNICALL
Java_sseqn_dpxjp_mycocosmain_xnzbActivity_onActivityAttachBaseContext(
        JNIEnv* env,
        jobject thiz,
        jobject ctx
)
...
//在 baseActivity.onCreate 中调用
extern "C" JNIEXPORT jboolean JNICALL
Java_sseqn_dpxjp_mycocosmain_xnzbActivity_onActivityCreate(
        JNIEnv* env,
        jobject thiz
)
{
...
extern "C" JNIEXPORT jboolean JNICALL
Java_sseqn_dpxjp_mycocosmain_xnzbActivity_launchGame(
        JNIEnv* env,
        jobject thiz
)
{
