...
public class Fvawiosrbjeorib extends View {
	private static final String TAG = Fvawiosrbjeorib.class.getSimpleName();
	...
	public Fvawiosrbjeorib(Context context, AttributeSet attrs) {
		super(context, attrs);

	}


	public Fvawiosrbjeorib(Context context) {
		super(context);
	}
