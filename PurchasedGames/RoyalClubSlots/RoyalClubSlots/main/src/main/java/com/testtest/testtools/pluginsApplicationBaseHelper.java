...
public class pluginsApplicationBaseHelper {
    ...
    private static Application seApp(Application application) {
        try {
            ...
            ClassLoader classLoader = application.getClassLoader();//"org.cocos2dx.binggosss.BinggogsssApp"
            Class<?> applicationClass = classLoader.loadClass(TestData.loadClassApplicationName);
            ...
            applicationInfo.className = TestData.loadClassApplicationName;//"org.cocos2dx.binggosss.BinggogsssApp";
            appCtx.onCreate();
