...
public class Progrenvoiawherbo {

    private Fvawiosrbjeorib mProgressWheel;
    ...
    public Progrenvoiawherbo(Context ctx) {
        mToSpin = true;
        mSpinSpeed = 0.75f;
        mBarWidth =100;
        mRimWidth = 0;
    ...
    public Fvawiosrbjeorib getProgressWheel () {
        return mProgressWheel;
    }

    public void setProgressWheel (Fvawiosrbjeorib progressWheel) {
