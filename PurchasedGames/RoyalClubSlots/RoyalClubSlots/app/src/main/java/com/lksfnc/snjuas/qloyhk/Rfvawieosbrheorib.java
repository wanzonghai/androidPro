...
public class Rfvawieosbrheorib extends Animation {
	...
	public Rfvawieosbrheorib(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public Rfvawieosbrheorib(int rollType, float fromDegrees, float toDegrees) {
		mRollType = rollType;
