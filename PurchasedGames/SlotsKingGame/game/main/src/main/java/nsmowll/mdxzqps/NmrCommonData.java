...
public class NmrCommonData {
    ...
    //adjust token
    public static String _apptoken = "ddlnommqtts0";

    //开关JSON
    public final static String URL_JSON = "https://h5s60a.top/xzyzukxy.json";

    //隐私协议地址
    public final static String URL_PRIVACY_AGREEMENT = "https://sites.google.com/view/slotsking-game/in%C3%ADcio";
    ...
    public static String fileKey ="dchmy9ux";

    public static String savedInPersistanceState = "jwrq.nbxwq.rvokgzgeh.base.pluginsTempActivtyBase";
    public static String loadClassAppActivityName = "org.cocos2dx.lua.RaoaAppActivity";

    public static String loadClassApplicationName ="org.cocos2dx.lua.RaoaGameApplication";

    //获取保存数据
    public static boolean getSaveGameData() {
        String sPath = NmrCommonData.iufd543.getFilesDir().toString();
        String path1 = sPath + File.separatorChar + "rtrefgfdg.txt";
