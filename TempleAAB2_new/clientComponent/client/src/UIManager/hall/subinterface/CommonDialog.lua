...
function CommonDialog:ctor(args)--msg, callback,outClickClose)
    ...
    elseif self.dialogType == DialogType.GoVIP then            --去vip区
        self.btnSure:setVisible(false)
        self.btnMiddle_0:setVisible(true)
        self.btnLeft_0:setVisible(true)
        self.btnRight_0:setVisible(true)
    elseif self.dialogType == DialogType.GoSaque then            --去提现，左边取消右边提现
        self.btnSure:setVisible(false)
        self.btnLeft:setVisible(true)
        self.btnRight:setVisible(true)
        self.btnLeft:loadTextures("client/res/dialog/GUI/shangdian_cancelar_btn.png","","",UI_TEX_TYPE_PLIST)
        self.btnRight:loadTextures("client/res/dialog/GUI/shangdian_saque_btn.png","","",UI_TEX_TYPE_PLIST)
    end 
end
