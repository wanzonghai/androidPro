...
GlobalData.EasyGameID = {
    ...
    [29400] = "Master Joker" ,--Master Joker 
    [32400] = "Fortune Ox",
    [32500] = "Fortune Tiger",
    [32600] = "Fortune Rabbit",
    [32700] = "Fortune Mouse",
}
...
GlobalData.GiftEnable   = nil --是否允许礼包
...
--获取Adjust 基础数据    
--App Token
GlobalData.AppToken = g_MultiPlatform:getInstance():getAdjustKey() 
--Google ADID
GlobalData.GoogleADID = g_MultiPlatform:getInstance():getAdjustGoogleAdId() 
--支付事件Token
GlobalData.RevenueToken = FunctionADLogName("ad_revenue")
--首充事件Token
GlobalData.FirstRevenueToken = FunctionADLogName("ad_firstRevenue")
--提现事件Token
GlobalData.WithdrawToken = FunctionADLogName("ad_withdraw_success")
--充提差事件Token
GlobalData.DWDifferenceToken = FunctionADLogName("ad_recharge_withdraw_difference")

--玩法下载监听代理
GlobalData.DownloadListener = nil
--玩法更新状态
GlobalData.DownloadStatus = {}
--玩法下载列表
GlobalData.DownloadGameList = {}
--当前下载玩法信息
...
--支付渠道列表
GlobalData.payChannelList = {}

--默认提现渠道
GlobalData.CashChannelList = {}