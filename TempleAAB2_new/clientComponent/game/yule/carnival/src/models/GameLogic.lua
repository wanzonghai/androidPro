...
GameLogic.MOVE_TIME_NORMAL          = 0.25           --普通旋转时间，第一列
GameLogic.TIME_NORMAL_ADD           = 0.3           --普通旋转每一列增加的时间
GameLogic.TIME_ADD_BONUS            = 1.0             --触发bonus之后每一列增加的旋转时间,快速模式减半
GameLogic.TIME_NETWORK_TIME         = 100000
