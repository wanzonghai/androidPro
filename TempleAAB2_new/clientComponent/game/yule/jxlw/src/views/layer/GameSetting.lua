...
function GameSetting:ctor(_gameView)
    ...
    self.csbNode = g_ExternalFun.loadCSB("Node_Setting.csb", self, false)
    self.csbNode:setPosition(1334/2-600,750-60)
...
function GameSetting:onClickBtnMusic()
    ...
    self._gameView:playBackgroundMusic()
end
