...
public class GoogleUtils {
    ...
    private String client_id = "697807306985-br20lq4okjm4klt36asgf4f5oqtfdlgd.apps.googleusercontent.com";
    private static ZzGameLoasufMhwopyw87 m_activity=null;
    ...
    public void initSDK(ZzGameLoasufMhwopyw87 activity){
        m_activity = activity;
        if (mGoogleSignInClient == null) {
