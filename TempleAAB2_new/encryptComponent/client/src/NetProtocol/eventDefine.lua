...
eventDefine.EVENT_BaseEnsureLoadConfig       = "event_BaseEnsureLoadConfig"   --破产补助 - 加载配置
eventDefine.EVENT_BaseEnsureGetStatus        = "event_BaseEnsureGetStatus"    --破产补助 - 获取用户状态
eventDefine.EVENT_BaseEnsureTakeReward       = "event_BaseEnsureTakeReward"   --破产补助 - 领取奖励

eventDefine.EVENT_PopWinPolicyLoadConfig        = "event_PopWinPolicyLoadConfig"    --客户端弹窗策略平台配置
eventDefine.EVENT_PopWinPolicyGetUserStatus       = "event_PopWinPolicyGetUserStatus"   --客户端弹窗策略用户配置
...
eventDefine.UI_JUMP_VIP_DIALOG                    = "UI_JUMPVIPDIALOG"             --跳转vip弹框
...
eventDefine.UI_OPENSELECTROOMLAYER                = "UI_OPENSELECTROOMLAYER"            --API游戏选择场次
eventDefine.UI_SHOW_ShareTelegram                 = "UI_SHOW_ShareTelegram"             --分享到飞机
eventDefine.C_SUB_LOAD_SIGN_CONFIG                = "C_SUB_LOAD_SIGN_CONFIG"            --加载签到配置返回
eventDefine.C_SUB_LOAD_SIGN_STATUS                = "C_SUB_LOAD_SIGN_STATUS"            --获取用户签到状态  
eventDefine.CMD_MB_PlacePayOrderResult            = "CMD_MB_PlacePayOrderResult"        --下单完成 事件
eventDefine.CMD_MB_PlaceWithdrawOrderResult       = "CMD_MB_PlaceWithdrawOrderResult"   --发起提现完成 事件
eventDefine.UI_SHOW_TURNTABLEHISTORY              = "UI_SHOW_TURNTABLEHISTORY"          --幸运转盘历史记录打开
eventDefine.CMD_MB_AlmzGetUserStatus              = "CMD_MB_AlmzGetUserStatus"          --vip救援金用户状态
eventDefine.CMD_MB_AlmzTakeRewardResult           = "CMD_MB_AlmzTakeRewardResult"       --vip救援金结果
eventDefine.UI_SHOW_VipHelperMoneyConfig          = "UI_SHOW_VipHelperMoneyConfig"      --打开vip帮助界面
eventDefine.UI_SHOW_VipHelpMoney                  = "UI_SHOW_VipHelpMoney"              --打开vip救援金界面
eventDefine.CMD_MB_AlmzLoadConfigResult           = "CMD_MB_AlmzLoadConfigResult"       --获取救援金VIP配置返回
return eventDefine