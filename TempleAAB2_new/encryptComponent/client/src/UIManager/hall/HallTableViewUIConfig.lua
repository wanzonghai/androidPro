...
local GameType = {
    ...
    EG          = "EasyGame",               --EG厂商
    PG          = "PocketGame",             --PG厂商
    ONE         = "OneAPI",                 --菲律宾厂商One API (2023-08-29)
}

--API游戏选场数据
local API_SelectRoomData = {
    [2500] = {{20,500},{500,10000},{1000,20000},{2000,100000}}
}
...
local Original = {
    ...
    [2500] = {ID=2500,Name="Game2500",desc="Teenpatti",Type=GameType.EG,gameType=GameType.SelectRoom},
    [2900] = {ID=2900,Name="Game2900",desc="7上7下",Type=GameType.EG},
    [3700] = nil,
    [4000] = nil,
    ...
    [29100]= nil,
    [29300]= nil,
    [29400]= {ID=29400,Name="Game29400",desc="Master Joker",Type=GameType.EG,},
    [32400]= {ID=32400,Name="Game32400",desc="FortuneOx",Type=GameType.EG,},
    [32500]= {ID=32500,Name="Game32500",desc="FortuneTiger",Type=GameType.EG,},
    [32600]= {ID=32600,Name="Game32600",desc="Fortune Rabbit",Type=GameType.EG,},
    [32700]= {ID=32700,Name="Game32700",desc="Fortune Mouse",Type=GameType.EG,},

    -- [2733] = {ID=2733,Name="Game2733",desc="Unknow Name",Type=GameType.ONE},
}

local TypeConfig = {
    All = {122,407,502,516,520,525,527,528,529,531,532,602,702,703,704,901,903,2500,4100,4200,4300,4400,4500,4600,4700,4800,5000,5100,5200,5300,5400,5500,5600,5800,5900,6000,6100,6200,6300,6400,6500,6600,6700,6800,6900,7000,7100,7300,7400,7600,7700,7800,7900,8100,8600,8700,8900,9100,9400,11000,12000,12100,32400,32500,32600,32700,23600,27100,27200,27400,27500,27600,27700,27800,27900,28000,28200,28300,28400,28600,28700,29400},
    Hot = {2,32500,32400,704,532,527,529,525,520,531,528,32600,32700,29400,23600,12100,11000,27100,27400},
    Slot = {32500,32400,532,529,704,527,525,531,528,516,502,32600,29400,32700,11000,12100,6100,4400,5900,6400,8600,4700,4600,7700,6300,5100,12000,4300,4200,6500,7400,5500,5600,7600,4800,5800,8900,7100,8100,6600,4100,7000,5400,7800,8700,7900,5000,4500,5200,9100,6000,5300,6700,6200,6900,6800,7300,9400},
...
HallTableViewUIConfig.API_SelectRoomData = API_SelectRoomData
