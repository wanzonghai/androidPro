    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if (msg.arg1 == -1) {
                ...
                dialog.setMessage("Boy, let's play again");
                dialog.setButton(DialogInterface.BUTTON_NEGATIVE, "No, I admit defeat", new DialogInterface.OnClickListener() {
                    @Override
                ...
                dialog.setButton(DialogInterface.BUTTON_POSITIVE, "Continue to challenge", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
            ...
            if (msg.arg1 == 1) {
                ...
                dialog.setButton(DialogInterface.BUTTON_NEGATIVE, "Haha, take a break", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                ...
                dialog.setButton(DialogInterface.BUTTON_POSITIVE, "Not addictive, do it again", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
