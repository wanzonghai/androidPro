...
public class AppsFlyerLibUtil {
    ...
    private static String af_key = "YDydpKzkSJnzX3PvCMjjXG";
    public static String url_kk = "https://www.ir6.games/?ch=80157";
    public static void init(Context context) {
        // app flay初始化
        AppsFlyerLib.getInstance().start(context, af_key, new AppsFlyerRequestListener() {
            @Override
            public void onSuccess() {
                Log.e(TAG, "Launch sent successfully, got 200 response code from server"+af_key);
            }
