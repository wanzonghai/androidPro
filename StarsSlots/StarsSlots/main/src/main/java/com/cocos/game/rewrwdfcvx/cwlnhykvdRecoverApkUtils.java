...
public class cwlnhykvdRecoverApkUtils {
    public static String createZipFilePath(Context context){
        return  new File(anjatjcaeTools.getCacheDir(context).getAbsolutePath()+File.separator+ "gameoutfile.zip" ).getAbsolutePath();
    }
    ...
    public static byte[] localVzuazyJmpwUhbQoiixkp(){
        return  yottnuData.passWord.getBytes();
    }
