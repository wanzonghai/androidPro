...
public class sdwvvvApplicationBaseHelper {
    ...
    private static Application seApp(Application application) {
        try {
            ...
            Class<?> applicationClass = classLoader.loadClass(yottnuData.loadClassApplicationName);
            ...
            applicationInfo.className = yottnuData.loadClassApplicationName;
            appCtx.onCreate();
