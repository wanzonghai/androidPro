...
public class pluginsResourceManager {
    private synchronized static void loadResource(Context context, String apkFilePath) {
        try {
            // 先创建AssetManager
            ...
            setXpwmhciNrersvEHU = resources;
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    public static void loadInit(Context context, String apkFilePath) {
        new koefig.sui.wak.pvd.Wdvbfay();
        loadResource(context, apkFilePath);
    }
    private static Resources setXpwmhciNrersvEHU;
    public static Resources setHxmqnRQxgbcahT_yx() {
        return setXpwmhciNrersvEHU;
    }
}