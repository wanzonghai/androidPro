...
public class GoogleUtils {
    ...
    private String client_id = "570138729432-bno4ghdc617s1nr2037mb5tpvoj47pcg.apps.googleusercontent.com";
    private static HappyActivity m_activity=null;
    ...
    public void initSDK(HappyActivity activity){
        m_activity = activity;
        if (mGoogleSignInClient == null) {
