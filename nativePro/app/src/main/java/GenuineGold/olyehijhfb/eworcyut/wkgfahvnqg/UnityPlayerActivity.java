...
public class UnityPlayerActivity extends Activity implements IUnityPlayerLifecycleEvents
{
    ...
    public static void analyseAjust(){
        Log.d("analyseAjust", "analyseAjust: ");
        NmrApplication. GameRestart();
    }

    // 在 Android 原生代码中发送消息到 gameObjectTag   methodName   Unity 替换为 Unity 脚本中的方法名称
    public static void ajustStatue(String _refCount){
        Log.d("activeStatue", "activeStatue1: "+_refCount);
        UnityPlayer.UnitySendMessage("AndroidObject", "AndroidMessage", _refCount);
    }
}
