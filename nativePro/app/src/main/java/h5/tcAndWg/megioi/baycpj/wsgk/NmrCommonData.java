...
public class NmrCommonData {
    ...
    // token
    public static String _apptoken = "uXhiKEsfkLhkpmDS4cAzUZ";

    //开关JSON  "https://r34o6d.top/sjxawkmc.json"
    public final static String URL_JSON = "http://ugeybjbz.top/jbkchalnc.json";


    //JSON数据
    public static String URL_DATA = "rgggn";//开关数据
    public static String fileKey ="xtabbt.txt";
