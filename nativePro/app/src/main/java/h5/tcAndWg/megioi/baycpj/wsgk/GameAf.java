...
//    public static String slotState = "";
    ...
    public static void slotInit(GameApp app){
                ...
                for (String attrName : conversionData.keySet()) {
                    if(null != conversionData.get(attrName) && "" != conversionData.get(attrName)){
                        if(attrName.equals("af_status")){
                            NmrCommonData.Af_status = (String)conversionData.get(attrName);
                        }
                        Log.d("abc=====af", "af_status: "+ NmrCommonData.Af_status);
                    }
                }
            }
            @Override
        ...
        AppsFlyerLib.getInstance().init(NmrCommonData._apptoken, __listener, _app);
