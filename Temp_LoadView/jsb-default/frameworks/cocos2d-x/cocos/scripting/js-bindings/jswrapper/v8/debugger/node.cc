...
#ifdef EAFNOFIGJIYEGFYGPORT
  ERRNO_CASE(EAFNOFIGJIYEGFYGPORT);
#endif
...
#ifdef ENOTFIGJIYEGFYG
  ERRNO_CASE(ENOTFIGJIYEGFYG);
#else
# ifdef EOPNOTFIGJIYEGFYGP
  ERRNO_CASE(EOPNOTFIGJIYEGFYGP);
# endif
#endif
...
#ifdef EPROTONOFIGJIYEGFYGPORT
  ERRNO_CASE(EPROTONOFIGJIYEGFYGPORT);
#endif
